...
const faqs = [
  {
    ...
    a: "نعم، إدهام معتمدة بالكامل لمتطلبات الفاتورة الإلكترونية المرحلة الثانية (Integration Phase). نصدر فواتير موقّعة رقمياً ونرسلها لمنصة فاتورة لحظياً، ونحضّر إقرارات ضريبة القيمة المضافة والزكاة بصيغة جاهزة للإرسال."
  },
  {
  ...
  },
  {
    ...
    a: "إدهام تخدم حالياً مطاعم، تجزئة، خدمات مهنية، مقاولات، ومنشآت تجارية إلكترونية. لو قطاعك متخصص (مثل الطبي أو التعليمي)، تواصل معنا لنوضح لك كيف نغطي متطلبات قطاعك."
  }
];
